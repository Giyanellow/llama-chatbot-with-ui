...
export default function Chat() {
  ...
  const examplePrompts = [
    {
      title: "What are some good spells",
      subtitle: "in Harry Potter?",
    },
    {
      title: "Who was the first wizard",
      subtitle: "from Gryffindor?",
    },
    {
      title: "Who is the author of",
      subtitle: "the Harry Potter series?",
    },
    {
      title: "What is the history of",
      subtitle: "the house of Slytherin?",
    },
  ]
